...
xMat6 = xV3 %*% t( xV3 )
xMat6 = xV3 %*% t( xV3 ) * 3 
xMat6 <- xMat6 + xV3 %*% t( xV3 )
xMat6 <- xMat6 + xV3 %*% t( xV3 ) * 3
xMat6 <- xMat6 - ( xV3 %*% t( xV3 ) )
xMat6 = xV3 %*% xV5
xMat6 = 2 * ( xV3 %*% xV5 )
xMat6 = xMat6 + ( xV3 %*% xV5 )
xMat6 <- xMat6 - ( xV3 %*% xV5 ) * 2
xMat6 = xMat6 + ( t( xV5 ) %*% xV5 )
xMat6 = xMat6 + xV3 %*% ( xV5 + xV6 ) ;
xMat6 = xMat6 + ( xV3 * 2 ) %*% ( xV5 + xV6 )
xMat6 = xMat6 - ( + xMat5 + ( ( xV3 + xV4 ) * 2 ) %*% ( xV5 + xV6 ) + xMat5 )
xMat6 <- solve( xMat6 )
xMat6 <- solve( xMat6 )
xMat5 = solve( xMat6 )
xMat11 = solve( xMat6 )
xMat6 = solve( xMat11 * 2 )
xMat6 = xMat6 + solve( xMat11 )
xMat6 = xMat6 + solve( xMat11 / 2 )
xMat6 = xMat6 - solve( xMat11 )
xMat6 = xMat6 - solve( xMat11 / 2 )
det( xMat6 )
det( xMat6 / 2 -xMat5 )
det( xMat5 )
xMat12 <- matrix( c(1, 7, 3, 3, 4, 6, 0, 5, 3, 2, 14, 15, 0, 6, 0, 16 ), 4, 4, byrow = T )
det(xMat12)
qr( xMat6 )
